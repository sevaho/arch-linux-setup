...
packages(){
  #Desktop
  pacman -S --noconfirm i3-wm i3 i3lock dmenu compton conky lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings feh imagemagick
  #Terminal
  ...
  #Other
  pacman -S --noconfirm dkms exfat-utils synaptics
  #Fonts, themes & icons
